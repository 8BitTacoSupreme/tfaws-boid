#!/usr/bin/env python3
"""Seed canon/iam-eval-rules.json with IAM policy evaluation order and interaction rules.

Sources:
- AWS IAM evaluation logic docs
- AWS cross-account evaluation docs
- Terraform aws_iam_policy / aws_iam_role_policy resource behavior
"""
...
FILENAME = "iam-eval-rules.json"


def build_evaluation_order() -> list[dict]:
    """Build the IAM policy evaluation order entries."""
    return [
        {
            "rule_order": 1,
...
def build_interaction_rules() -> list[dict]:
    """Build the IAM interaction/edge-case rules."""
    return [
        {
            ...
            "affected_resources": ["aws_s3_bucket_policy", "aws_sqs_queue_policy", "aws_kms_key", "aws_sns_topic_policy"]
        },
        {
            ...
            "affected_resources": ["aws_iam_role", "aws_s3_bucket_policy", "aws_kms_key"]
        },
        {
            ...
            "affected_resources": ["aws_kms_key", "aws_kms_alias", "aws_kms_grant"]
        },
        {
            ...
            "affected_resources": ["aws_iam_role", "aws_iam_role_policy", "aws_iam_role_policy_attachment"]
        },
        {
            ...
            "affected_resources": ["aws_iam_policy", "aws_iam_role_policy", "aws_iam_role"]
        },
        {
            ...
            "affected_resources": ["aws_iam_role", "aws_iam_policy", "aws_iam_role_policy_attachment", "aws_iam_instance_profile"]
        },
        {
            ...
            "affected_resources": ["aws_s3_bucket_policy", "aws_sqs_queue_policy", "aws_sns_topic_policy", "aws_kms_key"]
        },
        {
            ...
            "affected_resources": ["aws_iam_service_linked_role"]
        }
    ]
...
def main() -> None:
    ...
    data["evaluation_order"] = build_evaluation_order()
    data["interaction_rules"] = build_interaction_rules()

    path = save_canon(FILENAME, data)
    print(f"Wrote {len(data['evaluation_order'])} evaluation_order entries")
    print(f"Wrote {len(data['interaction_rules'])} interaction_rules entries")
