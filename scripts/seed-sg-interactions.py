#!/usr/bin/env python3
"""Seed canon/sg-interactions.json with security group interaction patterns.

Sources:
- hashicorp/terraform-provider-aws issues (circular deps, inline vs standalone)
- AWS security group documentation
- Terraform operational experience
"""
...
FILENAME = "sg-interactions.json"


def build_patterns() -> list[dict]:
    """Build the SG interaction pattern entries."""
    return [
        {
            ...
            "terraform_resources": ["aws_security_group", "aws_security_group_rule", "aws_vpc_security_group_ingress_rule", "aws_vpc_security_group_egress_rule"],
            "tags": ["rule-conflict", "perpetual-diff", "inline-vs-standalone"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group", "aws_security_group_rule"],
            "tags": ["cycle", "circular-dependency", "depends-on"],
            "references": ["https://github.com/hashicorp/terraform-provider-aws/issues/8170"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group", "aws_vpc_security_group_ingress_rule"],
            "tags": ["self-reference", "cluster", "cycle"]
        },
        {
            ...
            "tags": ["egress", "default-rule", "perpetual-diff"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group"],
            "tags": ["delete", "dependency-violation", "destroy"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group_rule", "aws_vpc_security_group_ingress_rule", "aws_ec2_managed_prefix_list"],
            "tags": ["limits", "rules-per-sg", "prefix-list"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group", "aws_security_group_rule"],
            "tags": ["ordering", "race-condition", "create-before-destroy"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group", "aws_security_group_rule"],
            "tags": ["stale-reference", "destroy-order", "depends-on"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group_rule", "aws_vpc_security_group_ingress_rule", "aws_vpc_peering_connection"],
            "tags": ["cross-vpc", "peering", "invalid-reference"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group"],
            "tags": ["naming", "force-replacement", "name-prefix"]
        },
        {
            ...
            "terraform_resources": ["aws_default_security_group", "aws_vpc"],
            "tags": ["default-sg", "security", "cis-benchmark"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group_rule", "aws_vpc_security_group_ingress_rule", "aws_vpc_security_group_egress_rule"],
            "tags": ["description", "immutable", "force-replacement"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group_rule", "aws_vpc_security_group_ingress_rule"],
            "tags": ["ipv6", "dual-stack", "rule-duplication"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group", "aws_lambda_function", "aws_ecs_service", "aws_lb"],
            "tags": ["timeout", "delete", "eni", "lambda"]
        },
        {
            ...
            "terraform_resources": ["aws_security_group_rule", "aws_vpc_security_group_ingress_rule"],
            "tags": ["for-each", "count", "index-shift", "best-practice"]
        }
    ]
...
def main() -> None:
    ...
    data["patterns"] = build_patterns()

    path = save_canon(FILENAME, data)
    print(f"Wrote {len(data['patterns'])} pattern entries")
