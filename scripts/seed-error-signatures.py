#!/usr/bin/env python3
"""Seed canon/error-signatures.json with Terraform+AWS error signatures.

Three channels:
1. GitHub Issues — top bug issues from terraform-provider-aws
2. CHANGELOG — BUG FIX and BREAKING CHANGE entries
3. Tribal knowledge — curated from operational experience

Sources: GitHub API, provider CHANGELOG, community knowledge
"""
...
from canon_lib import load_canon, save_canon, make_meta, dedup_by_field

FILENAME = "error-signatures.json"


def channel_github_issues() -> list[dict]:
    """Channel 1: Error signatures from high-engagement GitHub issues."""
    return [
        {
            ...
            "severity": "high",
            "tags": ["inconsistent-plan", "tags-all", "eventual-consistency", "provider-bug"]
        },
        {
            ...
            "severity": "high",
            "tags": ["platform", "init", "lock-file", "arm"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["rds", "destroy", "snapshot", "lifecycle"]
        },
        {
            ...
            "severity": "high",
            "tags": ["security-group", "dependency", "destroy", "eni", "lambda"]
        },
        {
            ...
            "severity": "high",
            "tags": ["lambda", "iam", "eventual-consistency", "trust-policy"]
        },
        {
            ...
            "severity": "high",
            "tags": ["eni", "security-group", "lambda", "timeout", "destroy"]
        },
        {
            ...
            "severity": "high",
            "tags": ["cycle", "security-group", "circular-dependency"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["ec2", "capacity", "instance-type", "az"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["iam", "already-exists", "import", "state"]
        },
        {
            ...
            "severity": "critical",
            "tags": ["credentials", "auth", "provider", "sso"]
        },
        {
            ...
            "severity": "critical",
            "tags": ["state", "lock", "backend", "dynamodb", "concurrent"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["s3", "naming", "global-namespace", "import"]
        },
        {
            ...
            "severity": "high",
            "tags": ["s3", "policy", "access-denied", "lockout"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["subnet", "vpc", "instance", "invalid-parameter"]
        },
        {
            ...
            "severity": "high",
            "tags": ["iam", "authorization", "debug", "encoded-message"]
        },
        {
            ...
            "severity": "high",
            "tags": ["ecs", "health-check", "steady-state", "timeout"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["ecs", "cluster", "not-found", "fargate"]
        },
        {
        ...
        },
        {
            ...
            "severity": "medium",
            "tags": ["rds", "state", "modification", "pending"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["alb", "elb", "subnet", "multi-az"]
        }
    ]


def channel_changelog() -> list[dict]:
    """Channel 2: Error signatures from provider CHANGELOG bug fixes."""
    return [
        {
            ...
            "severity": "medium",
            "tags": ["eni", "detach", "provider-bug", "upgrade"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["iam", "user", "rename", "provider-bug"]
        },
        {
            ...
            "severity": "high",
            "tags": ["dynamodb", "panic", "dynamic-block", "provider-bug"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["elasticache", "auth", "migration", "provider-bug"]
        },
        {
            ...
            "severity": "high",
            "tags": ["elasticache", "serverless", "upgrade", "force-replace", "provider-bug"]
        },
        {
            ...
            "severity": "critical",
            "tags": ["provider-bug", "identity", "v6", "regression"]
        },
        {
            ...
            "severity": "critical",
            "tags": ["init", "crash", "arm", "provider-binary"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["acm", "certificate", "limit", "cleanup"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["route53", "hosted-zone", "already-exists", "import"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["cloudwatch", "logs", "already-exists", "lambda", "import"]
        }
    ]


def channel_tribal() -> list[dict]:
    """Channel 3: Curated tribal knowledge — errors that aren't in issues/changelogs."""
    return [
        {
            ...
            "severity": "high",
            "tags": ["count", "for-each", "plan-time", "computed"]
        },
        {
            ...
            "severity": "high",
            "tags": ["tags", "default-tags", "inconsistent", "provider"]
        },
        {
        ...
        },
        {
            ...
            "severity": "medium",
            "tags": ["backend", "variables", "init", "partial-config"]
        },
        {
        ...
        },
        {
            ...
            "severity": "low",
            "tags": ["plan", "stale", "state", "concurrency"]
        },
        {
            ...
            "severity": "high",
            "tags": ["backend", "s3", "bootstrap", "state"]
        },
        {
            ...
            "severity": "high",
            "tags": ["kms", "decrypt", "key-policy", "iam"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["backend", "init", "migration", "corrupt"]
        },
        {
            ...
            "severity": "high",
            "tags": ["state", "lock", "dynamodb", "conditional-check"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["null", "conditional", "count", "try"]
        },
        {
            ...
            "severity": "low",
            "tags": ["reference", "undeclared", "moved", "rename"]
        },
        {
            ...
            "severity": "high",
            "tags": ["for-each", "computed", "plan-time", "keys"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["provider", "module", "alias", "configuration"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["timeout", "create", "waiting", "slow-resource"]
        },
        {
        ...
        },
        {
            ...
            "severity": "medium",
            "tags": ["state", "version", "upgrade", "team"]
        },
        {
        ...
        },
        {
            ...
            "severity": "high",
            "tags": ["crash", "plugin", "memory", "provider"]
        },
        {
            ...
            "severity": "medium",
            "tags": ["lock", "dependency", "init", "cross-platform"]
        }
    ]
...
def main() -> None:
    ...
    # Merge all channels
    all_sigs = channel_github_issues() + channel_changelog() + channel_tribal()

    # Dedup by error_pattern
    all_sigs = dedup_by_field(all_sigs, "error_pattern")

    data["signatures"] = all_sigs

    path = save_canon(FILENAME, data)
    print(f"Wrote {len(data['signatures'])} error signature entries")
    print(f"  Channel 1 (GitHub issues): {len(channel_github_issues())}")
    print(f"  Channel 2 (CHANGELOG): {len(channel_changelog())}")
    print(f"  Channel 3 (Tribal): {len(channel_tribal())}")
